...
public class LatestActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setAdapter(new LatestAdapter(this));
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_latest) {
            ...
            Intent intent = new Intent(LatestActivity.this,LatestActivity.class);
            ...
            Intent intent = new Intent(LatestActivity.this,AboutActivity.class);
            startActivity(intent);
